...
#### 3.3.2 `01.03.2021`
- [ISL-9703](https://st.yandex-team.ru/ISL-9703): Tumbler.ts: Ломается верстка при длинном лейбле [[#20823](https://github.yandex-team.ru/search-interfaces/frontend/pull/20823)]
  - 🛠 fix: fix button width in flex [[ca60f5](https://github.yandex-team.ru/search-interfaces/frontend/commit/ca60f5d83b1b6998a0360601a45d78dd66022165)]
