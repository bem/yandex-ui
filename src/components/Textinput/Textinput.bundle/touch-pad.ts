...
import { ITextinputProps as ITextinputTouchPadProps, Textinput as TextinputTouchPad } from '../Textinput@touch-pad';
// _size
...
// _hasClear
import { withHasClear } from '../_hasClear/Textinput_hasClear@touch-pad';
// _pin
...
export interface ITextinputProps extends ITextinputTouchPadProps {
    size?: 'm' | 's';
...
export const Textinput = compose(
    ...
    withBaseline,
    withHasClear,
)(TextinputTouchPad) as FC<ITextinputProps>;
