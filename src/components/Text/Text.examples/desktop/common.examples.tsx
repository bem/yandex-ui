...
import { Text, TextProps, TextTypographyValue } from '../../Text.bundle/desktop';
...
const Unit: FC<Partial<TextProps> & { groupId?: string }> = ({
    ...
    const typographySelect = select<TextProps['typography']>('Typography', typographyValues,
        typography as TextTypographyValue, groupId);
