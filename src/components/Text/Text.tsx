...
import './Text.css';
import './_color/Text_color.css';

export type TextAlignValue = 'start' | 'end' | 'center' | 'justify';

export type TextOverflowValue = 'fade' | 'ellipsis' | 'fade-horizontal';

export type TextColorValue = 'brand' | 'inverse' | 'primary' | 'promo' | 'secondary' | 'ghost' | 'control-primary' |
    'alert' | 'warning' | 'disable' | 'success' |
    'control-secondary' | 'control-passive' | 'control-ghost' | 'control-faint' | 'control-disable' | 'control-link' |
    'control-error' |
    'link' | 'link-external' | 'link-minor' | 'link-hover';
