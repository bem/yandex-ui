import React, { useCallback, useState, useEffect, useMemo, RefObject, ReactNode, MouseEventHandler, useRef } from 'react';
...
export const Image: React.FC<IImageProps> = (props) => {
    ...
    const mergedRefs = useMemo(() =>
        mergeAllRefs<HTMLImageElement>(imageRef, innerRef), [imageRef, innerRef],
    );
