...
const SelectPresenter = class extends PureComponent<SelectProps> {
    ...
    componentDidUpdate(prevProps: SelectProps) {
        ...
        const inChangeValue = Array.isArray(this.props.value) && prevProps.value.length !== this.props.value.length;
    ...
    private onMenuChange = (event: ChangeEvent<HTMLSelectElement>) => {
