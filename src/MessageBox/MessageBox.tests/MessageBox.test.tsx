...
describe('MessageBox', () => {
    ...
    describe('client environment', () => {
        ...
        // TODO enzyme находит 3 ноды вместо 1
        // переписать с помощью react-testing-library
        xtest('должен устанавливать/удалять модификаторы при обновлении через props', () => {
