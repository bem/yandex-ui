    ...
    return (
        <span className="Icon Icon_hasGlyph Icon_size_m" style={{ width: 24 }}>
            <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                <path d="M10 .75A2 2 0 008.15 2h-2.4A3.758 3.758 0 002 5.75v8.5A3.758 3.758 0 005.75 18H6v.25A3.758 3.758 0 009.75 22h8.5A3.758 3.758 0 0022 18.25v-8.5A3.758 3.758 0 0018.25 6H18v-.25A3.758 3.758 0 0014.25 2h-2.4A2 2 0 0010 .75zM5.75 3.5h.32A1.99 1.99 0 008 5h4a1.99 1.99 0 001.93-1.5h.32c1.26 0 2.25.99 2.25 2.25V6H9.75A3.758 3.758 0 006 9.75v6.75h-.25a2.23 2.23 0 01-2.25-2.25v-8.5A2.23 2.23 0 015.75 3.5zm4 4h8.5c1.259 0 2.25.99 2.25 2.25v8.5a2.23 2.23 0 01-2.25 2.25h-8.5a2.23 2.23 0 01-2.25-2.25v-8.5c0-1.259.99-2.25 2.25-2.25zm1 2.75c-1.014-.014-1.014 1.514 0 1.5h6.5c1.014.014 1.014-1.514 0-1.5zm0 3c-1.014-.014-1.014 1.514 0 1.5h6.5c1.014.014 1.014-1.514 0-1.5zm0 3c-1.014-.014-1.014 1.514 0 1.5h4.5c1.014.014 1.014-1.514 0-1.5z" />
            </svg>
        </span>
    );
};
    ...
    return (
        <span className="Icon Icon_hasGlyph Icon_size_m" style={{ width: 24 }}>
            <svg width="24" height="24" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M20 10h2v12H2V10h2v10h16V10zm-8-8l4 6h-3v8h-2V8H8l4-6z"
                    fill="#000000"
                    stroke="none"
                    stroke-width="1"
                    fillRule="evenodd"
