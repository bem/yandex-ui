...
const Unit: FC<Partial<TextProps> & { groupId?: string }> = ({
    ...
    return <Text as={as} className={className} typography={typographySelect} weight={weightSelect} {...props} />;
};
...
export const Common = () => {
    ...
    return (
        <section
            className={[cnTheme(presets[preset]), 'text-common-example'].join(' ')}
        ...
        >
            ...
            <Paragraph typography="body-short-xl" style={{ columnCount: 2 }} className="body-short">
                ...
                во внутренних документах Яндекса. Важно, чтобы к достижению этой цели стремился каждый член команды
                Яндекс ожидает, что члены команды будут чувствовать ответственность не только за свою часть работы, но и
                за продукт в целом. Будьте неравнодушны к отзывам пользователей, предлагайте усовершенствования.
            </Paragraph>
            <ul>
                <li>
                    <img src={maps} alt="" />
